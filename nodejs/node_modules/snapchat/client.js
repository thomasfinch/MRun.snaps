...
Client.prototype.addToStory = function(mediaId,timeOrCb,cb) {
    var time;
    if(typeof timeOrCb === 'function') {
        cb = timeOrCb;
    } else {
    ...
    return sc.addToStory(this.username, this.auth_token, mediaId, time).nodeify(cb);
}
