...
/** @const */ var user_agent = e.user_agent = "Snapchat/9.6.0.0 (Nexus 5; Android 21; gzip)";
...
e.addToStory = function addToStory(username, auth_token, mediaId, time, cb) {
    var ts = Date.now()+'';
    var mediaType = (time < 0) ? 1 : 0;
    var postData = {
        username: username,
        auth_token: auth_token,
        media_id: mediaId,
    ...
    if(typeof time != 'undefined') postData.time = time;
    return e.postCall('/bq/post_story', postData, auth_token,ts).nodeify(cb);
}
